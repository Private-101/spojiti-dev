  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-sp-body-bg shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${
