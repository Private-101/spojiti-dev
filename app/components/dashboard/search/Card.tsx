...
import type { FormattedJobPost } from '~/models/job.server';

interface CardProps { jobs: any; handleFilter: any; jobClicked: any; setJobClicked: any };
    ...
    <div className="py-3 sm:px-20 px-5 max-w-7xl mx-auto">
      <div className="bg-white py-5 px-10 lg:flex lg:justify-between items-center drop-shadow-2xl rounded-lg">
          ...
          <div className="flex pb-1 pt-1">
            <div>
              ...
              <div
                // value={jobs.position}
                // onClick={(event) => {
                  // setJobClicked(event.currentTarget.innerText)
                // }}
              >
                <button
                  value={jobs.position}
                  onClick={(event) => {
                    setJobClicked(event.currentTarget.value)
                  }}
        ...
        <div className="">
          ...
          >
            {jobs.filters.map((filter: string | null | undefined, index: React.Key | null | undefined) => (
              <button
