		...
		>
			<Link
				...
				className={cn(
					...
					menuOpen ? "lg:flex md:flex" : hiddenSooner ? "lg:hidden" : "md:hidden"
				)}
			>
			...
			<button
				className={cn(
					"z-10 absolute inset-0 justify-center items-center w-0 h-0 overflow-hidden focus:w-auto focus:h-auto bg-white dark:bg-black",
					menuOpen ? "lg:flex md:flex" : "hidden"
				)}
