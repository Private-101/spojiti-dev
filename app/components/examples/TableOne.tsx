import BrandOne from '~/components/common/assets/images/brand/brand-01.svg';
import BrandTwo from '~/components/common/assets/images/brand/brand-02.svg';
import BrandThree from '~/components/common/assets/images/brand/brand-03.svg';
import BrandFour from '~/components/common/assets/images/brand/brand-04.svg';
import BrandFive from '~/components/common/assets/images/brand/brand-05.svg';

const TableOne = () => {
  return (
    <div className="rounded-sm border border-stroke bg-sp-body-bg px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <h4 className="mb-6 text-xl font-semibold text-black dark:text-white">
        Top Channels
      </h4>

      <div className="flex flex-col">
        <div className="grid grid-cols-3 rounded-sm bg-grayFlat-2 dark:bg-meta-4 sm:grid-cols-5">
