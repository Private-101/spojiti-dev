...
import UserFive from '~/components/common/assets/images/user/user-05.png';

const ChatCard = () => {
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-sp-body-bg py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
