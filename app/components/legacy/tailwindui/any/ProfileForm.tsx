    ...
    return (
        <>
            <div className="max-w-2xl mx-auto">
                ...
                <p className="mt-5">Check out the original floating label form elements on 
                <a className="text-blue-600 hover:underline"
                    href="#blank" target="_blank">Flowbite</a> and browse other similar components built with Tailwind CSS.
                </p>
            </div>
        </>
    )
