...
<div
id="wrapper"
  className="py-5 px-6 mx-2 mt-10 mb-6 leading-6 text-center text-black bg-gray-800 rounded-lg lg:mt-0 xl:px-10"
>
<div id="inner-wrapper" className="leading-6 text-center text-black">
<img
  id="avatar"
  className="block mx-auto w-32 max-w-full h-32 leading-6 text-center text-transparent align-middle rounded-full"
  src="/images/global/avatar-big.webp"
  alt="author avatar"
/>
<div
id="details-group"
  className="flex flex-col justify-center items-center text-lg font-medium leading-6 text-center text-black"
>
<h3 id="title" className="m-0 leading-6 text-center text-white">Borislav Hadzhiev</h3>
<p
id="subtitle"
  className="mx-0 mt-3 mb-0 text-lg font-medium leading-6 text-center text-indigo-300"
>
  Web Developer
</p>
<div id="links-group"
  className="flex justify-center mt-3 mb-0 text-lg font-medium leading-6 text-center text-black"
>
<svg
id="twitter"
  stroke="currentColor"
  ...
  stroke-width="0"
  viewBox="0 0 512 512"
  className="block w-6 h-6 text-lg font-medium leading-6 text-center text-gray-100 align-middle cursor-pointer"
  height="1em"
  width="1em"
...
<path
  ...
  className="text-lg font-medium leading-6 text-center text-gray-100 cursor-pointer"
></path>
</svg>
...
id="linkedin"
  ...
  stroke-width="0"
  viewBox="0 0 448 512"
  className="block w-6 h-6 text-lg font-medium leading-6 text-center text-gray-400 align-middle cursor-pointer"
  height="1em"
  width="1em"
  xmlns="http://www.w3.org/2000/svg"
>
...
const VerticalUserCard = React.forwardRef<HTMLDivElement, CardProps>((props, ref) => {
