...
export default function NavbarSectionHero() {
    return (
        <>
            {/* <!-- Header --> */}
            <header>
                    ...
                    <div className="bg-gray-100 sm:grid grid-cols-5 grid-rows-2 px-4 py-6 min-h-full lg:min-h-screen space-y-6 sm:space-y-0 sm:gap-4">
                        ...
                        <div className="h-96 col-span-4 bg-gradient-to-tr from-indigo-800 to-indigo-500 rounded-md flex items-center">
                            <div className="ml-20 w-80">
                                ...
                                <a href="/" className="uppercase inline-block mt-8 text-sm bg-sp-body-bg py-2 px-4 rounded font-semibold hover:bg-indigo-100">get start</a>
                            </div>
                        ...
                        <div className="h-96 col-span-1 ">
                            ...
                            <div className="bg-sp-body-bg  rounded-md">

                                <h1 className="text-center text-xl my-4  bg-sp-body-bg py-2 rounded-md border-b-2 cursor-pointer  text-gray-600">Service</h1>
                                <div className="bg-sp-body-bg rounded-md list-none  text-center ">
