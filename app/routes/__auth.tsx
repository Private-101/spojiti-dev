...
export default function AuthRoute() {
  return (
    <>
      <div className="flex flex-1 flex-col justify-center min-h-screen bg-gray-100 dark:bg-gray-800">
        <Header />
        <Outlet />
        <footer
  ...
  <svg viewBox="0 0 150 100" xmlns="http://www.w3.org/2000/svg" className="sm:w-1/2 mx-auto h-16 w-auto " fill="#f58321">
            <text x="0" y="80" fontSize="48" fontFamily="Arial" fontWeight="bold" className="">SPOJITI</text>
        </svg>
...
function Header() {
  return (
    <>
    <header data-testid="layout-header" className="bg flex h-12 items-center justify-between px-1.5 sm:fixed sm:top-0 sm:z-10 sm:w-full sm:bg-opacity-80 sm:backdrop-blur sm:backdrop-filter">
      <a href="/">
    ...
    <div className="flex space-x-2">
      <a className="font-semibold sm:pr-6 shadow-sm !text-gray-700 dark:!text-gray-300 bg-white hover:bg-gray-50 dark:bg-gray-800 b dark:hover:bg-gray-700 px-4 py-2 text-sm !no-underline inline-flex items-center justify-center border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500" href="https://www.youtube.com/channel/UCu_HEH2tNSzIQnjWMrw0A8w" target="_blank" rel="noreferrer">
      <TvIcon />
      <span className="hidden sm:inline-block">YouTube</span>
    </a>
    <div className="opacity-100 translate-y-0">
      <button data-testid="login-button" className="border-transparent shadow-sm !text-white bg-primary-600 hover:bg-primary-700 px-4 py-2 text-sm !no-underline inline-flex items-center justify-center border font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 h-9.5">Sign in with GitHub</button>
    </div>
    </div>
    </header>
    </>
