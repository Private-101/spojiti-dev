	...
	return (
        ...
        <nav className="container mx-auto px-4 py-2 flex items-center">
            ...
            <div className="searchbar flex-auto relative">
                ...
                <svg className="absolute top-2 left-2 h-4 w-4 text-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8" stroke="currentColor" stroke-width="2"></circle><path d="M21 21l-4.35-4.35" stroke="currentColor" stroke-width="2"></path></svg>
                <button id="clearSearch" className="absolute top-1 right-2 w-5 h-5 text-gray-400" onClick={() => { /* Clear search logic */ }}>
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 6L6 18" stroke="currentColor" stroke-width="2"></path><path d="M6 6l12 12" stroke="currentColor" stroke-width="2"></path></svg>
                </button>
            </div>
