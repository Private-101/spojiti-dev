...
export const meta: V2_MetaFunction = () => [{ title: "Spojiti Cover Page" }];
...
export default function Index() {
  ...
  return (
    <main className="relative min-h-screen bg-sp-body-bg sm:flex sm:items-center sm:justify-center">
            ...
            <div className="relative px-4 pb-8 pt-16 sm:px-6 sm:pb-14 sm:pt-24 lg:px-8 lg:pb-20 lg:pt-32">
              ...
              <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                {user ? (
                  <Link
                    to="/notes"
                    className="flex items-center justify-center rounded-md border border-transparent bg-sp-body-bg px-4 py-3 text-base font-medium text-yellow-700 shadow-sm hover:bg-yellow-50 sm:px-8"
                  >
