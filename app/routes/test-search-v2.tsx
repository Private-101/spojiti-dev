    ...
    <>
      <div className="relative mx-auto w-full max-w-sm pt-6">
        <div className="relative inline-block w-full transform transition-transform duration-300 ease-in-out">
          ...
          <ApplyButtonModal />
            {/*<p className='uppercase inline-block mt-8 text-lg bg-transparent hover:bg-sp-body-bg/20 text-white py-2 px-4 rounded font-semibold'>Apply</p>*/}
        ...
        {/*<a href={`/app/jobs/${id}`} className="uppercase inline-block mt-8 text-lg bg-sp-body-bg py-2 px-4 rounded font-semibold hover:bg-indigo-100">apply</a>*/}
        </div>
