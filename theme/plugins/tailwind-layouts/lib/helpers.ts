...
let helperOptions: PluginOptions;

export const cn = (options: PluginOptions = helperOptions, key: keyof PluginOptions['classNames']) => helperOptions.classNames[key] ?? options.classNames[key];
